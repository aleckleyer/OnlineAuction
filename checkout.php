<?php
	...
	if(isset($_POST['paymentbtn'])){
		$buyid = 0;
		foreach($cart_array as $ch=>$vl){
			$del_id = $cart_array[$ch]["ProductID"];
			$update_stmt = $db_handle->runQuery("UPDATE product SET BuyerID = '".$buyid."' WHERE ProductID = '".$del_id."'");
		}
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <button type="submit" class="btn btn-primary btn-submit-fix" name="paymentbtn">SUBMIT</button>
