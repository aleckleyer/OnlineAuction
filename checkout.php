                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 col-md-push-6 col-sm-push-6">
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
							<?php
								$cart_array = $_SESSION['shopping-cart'];
								$total = 50;
								foreach($cart_array as $key=>$value){
							?>
                            <div class="form-group">
                                <div class="col-sm-3 col-xs-3">
                                    <img class="img-responsive" src="product-img/<?php echo $cart_array[$key]["Img"];?> " />
                                </div>
                                <div class="col-sm-6 col-xs-6">
                                    <div class="col-xs-12"><?php echo $cart_array[$key]["Name"]; ?></div>
                                    <div class="col-xs-12"><small>Quantity:<span>1</span></small></div>
                                </div>
                                <div class="col-sm-3 col-xs-3 text-right">
                                    <h6><span>$</span><?php echo $cart_array[$key]["Price"]; ?></h6>
                                </div>
								<?php
									$total = $total + $cart_array[$key]["Price"];
								?>
                            </div>
							<?php } ?>
                            ...
                            <div class="form-group">
                                <div class="col-xs-12">
                                    ...
                                    <div class="pull-right"><span>$</span><span>50</span></div>
                                </div>
                                <div class="col-xs-12">
